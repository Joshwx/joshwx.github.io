...
#fgen stuff
cf=ax.contourf(lon,lat,fgen_masked,np.arange(-8,9,),cmap='bwr',extend='both',transform=ccrs.PlateCarree())
line1=ax.contour(lon, lat,fgen_masked,colors='black',linewidths=1.5,
