...
#fgen calculation
theta_925=mpcalc.potential_temperature(level, temp_850)
print(theta_925)
dx,dy= mpcalc.lat_lon_grid_deltas(lon, lat)
fronto_850=mpcalc.frontogenesis(theta_925, u, v, dx, dy)
...
#fgen stuff
cf=ax.contourf(lon,lat,fgen_smoothed*convert_to_per_100km_3hr,np.arange(-8,8.5,.5),cmap='bwr',extend='both',transform=ccrs.PlateCarree())
...
ax.set_title(f'925mb Frontogenisis (K/100km/3hr)', fontsize=26, loc='center')
