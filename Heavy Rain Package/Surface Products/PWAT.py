...
#pull from model
H= Herbie("2026-05-25 03:00", model='rap', product='awp130pgrb')
...
#smoothing
pwat_smooth=gaussian_filter(pwat,1)
mslp_smooth=gaussian_filter(mslp,1)
...
#mslp contours
line1=ax.contour(lon, lat,mslp,levels=list(np.arange(940, 1072, 2)),colors='black',linewidths=2,
